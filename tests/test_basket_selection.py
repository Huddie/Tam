...
def test_cluster_separates_two_distinct_correlation_groups():
    ...
    noise = lambda: rng.normal(0, 0.002, 300)
...
def test_downside_quantile_restricts_correlation_to_bad_days():
    ...
    normal_b = [-0.010, -0.008, -0.015, -0.009, -0.012, -0.011, -0.007, -0.013, -0.010, -0.014, -0.009, -0.012, -0.010, -0.011, -0.008]
    crash_a = [-0.080, -0.090, -0.070, -0.085, -0.088]
    crash_b = [-0.079, -0.091, -0.069, -0.086, -0.089]
    normal_c = [0.005, -0.003, 0.002, -0.004, 0.006, -0.002, 0.003, -0.005, 0.004, -0.003, 0.002, -0.004, 0.005, -0.002, 0.003]
    normal_d = [-0.004, 0.002, -0.003, 0.005, -0.002, 0.004, -0.003, 0.002, -0.005, 0.004, -0.002, 0.003, -0.004, 0.002, -0.003]
